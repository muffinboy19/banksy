package com.banksy.app.modules.activity.`data`.model
...
data class ModelModel(
   ...
   * TODO Replace with dynamic value
   */
  var txt1623jan: String? = MyApp.getInstance().resources.getString(R.string.lbl_16_23_jan)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtActivityThree: String? = MyApp.getInstance().resources.getString(R.string.lbl_activity)
  ,
  /**
   * TODO Replace with dynamic value
   */
