package com.banksy.app.modules.receivemoneyrequest.`data`.model

import com.banksy.app.R
import com.banksy.app.appcomponents.di.MyApp
import kotlin.String

data class ReceiveMoneyRequestModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtCompanyname: String? = MyApp.getInstance().resources.getString(R.string.lbl_company_name)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtAttachfileoptio: String? =
      MyApp.getInstance().resources.getString(R.string.msg_attach_file_optional)
  ,
  /**
   * TODO Replace with dynamic value
   */
